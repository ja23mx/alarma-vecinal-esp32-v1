...
private:
    ...
    // CmdMem.cpp ////////////////////////////////////////////////////////////////////////////////
    void processMemJson(void);
    void readMemConfig(void);
    void readMemWifi(void);
    void readMemRF(void);
    void writeMemConfig(void);
    void writeMemWifi(void);
    void writeMemRF(void);
    void buildMemHeader(const char *target, uint8_t status);
    ///////////////////////////////////////////////////////////////////////////////////////////////
